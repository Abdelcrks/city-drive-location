...
export const cars: Car[] = [
...

	{
		...
		description:'Inspirée du savoir-faire Alpine, cette Clio 5 se distingue par son design sportif et élégant. Elle offre une conduite dynamique tout en conservant le confort et la polyvalence d’une citadine moderne.',
	...
	},
    {
		...
		color: 'Black',
		image: '/visuels/no-picture.png',
		description:"SUV ultra-sportif de prestige, le Lamborghini Urus combine puissance impressionnante, luxe extrême et design agressif. Un véhicule d’exception destiné à ceux qui recherchent performance, exclusivité et sensations fortes.",
		images:["/visuels/no-picture.png"],
	},
]